...
import com.speedata.camerapreviewtest.AppCamera;
...
public class ToastUtils {
    ...
    public static void showShortToastSafeCenter(final @StringRes int resId) {
        Toast toast = Toast.makeText(AppCamera.getInstance(), resId, Toast.LENGTH_SHORT);
    ...
    public static void showShortToastSafeCenter(final CharSequence text) {
        Toast toast = Toast.makeText(AppCamera.getInstance(), text, Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.CENTER, 0, 0);
        toast.show();
    }
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppCamera.getInstance().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppCamera.getInstance().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(AppCamera.getInstance(), text, duration);
        } else {
            sToast.setText(text);
